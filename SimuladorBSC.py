...
if st.session_state.paso == 1:
    ...
    st.markdown("<h3 style='text-align: left; color: #1E3A8A; font-size: 12px;'>Instrucciones: este simulador fue elaborado para que los estudiantes diseñen una estrategia y luego simular la toma de decisiones y que se comprenda el impacto que tiene cada decisión.</h1>", unsafe_allow_html=True)
