...
if st.session_state.paso == 1:
    ...
    st.markdown("<h3 style='text-align: center; color: #1E3A8A; font-size: 30px;'>Creado por: Dr. Alejandro Orantes Kestler</h1>", unsafe_allow_html=True)
    st.markdown("<h3 style='text-align: left; color: #1E3A8A; font-size: 20px;'>Instrucciones: este simulador fue elaborado para que los estudiantes diseñen una estrategia y luego simular la toma de decisiones y que se comprenda el impacto que tiene cada decisión.</h1>", unsafe_allow_html=True)
    ...
    with st.form("diagnostico_form"):
        ...
        campos_canvas = ["Propuesta de Valor", "Procesos/actividades Clave1","Procesos/Actividades Clave2","Procesos/Actividades Clave3", "Procesos/Actividades Clave4", "Recursos Tecnologico Clave","Recursos Humano Clave", "Recursos Informatico clave", "Infraestructura clave", "Socios Clave"]
        respuestas_canvas = {}
